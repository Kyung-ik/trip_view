...
public class TripviewBoardResponseDto {
	...
	public TripviewBoard toEntity() {
	   ...
	   @Builder
	   public TripviewBoardResponseDto(Long id,String title,String content, double grade,Long member, String memberNickname, LocalDateTime createTime, int readCnt, int likeNum) {
	      this.id =id;
	      this.title =title;
